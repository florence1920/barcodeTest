...
<style scoped>
    ...
    .cam .barrier.v1 {position: absolute;top: 200px;left: 0; width: 100px; height: 266px; background-color: rgba(0,0,0,.5); z-index: 1;}
    .cam .barrier.v2 {position: absolute;top: 200px;right: 0; width: 100px; height: 266px; background-color: rgba(0,0,0,.5); z-index: 1;}
    /* .cam .barrier.b1 {width: 100%; height: 50px;} */
    .cam .scanner {width: 100%; height: 650px;}
</style>